...
class Customizer_Options
{
    ...
    public function register_options($wp_customize)
    {
        ...
        Kirki::add_field('servicos_image', [
            'type'     => 'image',
            'settings' => 'servicos_image',
         ...
         */
        Kirki::add_field(
            'aboutus_missao_valores',
            array(
                'type'      => 'custom',
                'settings'  => 'aboutus_missao_valores',
                'section'   => $section,
                'default'   => '<h3 class="customize-section-title">'
                    . __('Missão & Valores')
                    . '</h3>'
        ...
        Kirki::add_field('missao', [
            'type'     => 'textarea',
            'settings' => 'missao',
            'label'    => esc_html__('Missão'),
            'section'  => $section
        ]);

        Kirki::add_field('valores', [
            'type'     => 'textarea',
            'settings' => 'valores',
